...
direction = map.directions(origin=coord_list[0], destination=coord_list[0], waypoints=coord_list, optimize_waypoints = True, mode='driving')
...
with open("./data/route.json", "r+") as route_file:
    ...
    route_direction = route_direction[:-4]
